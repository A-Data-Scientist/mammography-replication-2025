...
def main() -> None:
    ...
    :return: None
    """
    csv_root = '/data'               # original csv folder (change as needed)
    img_root = '/data/CBIS-DDSM'     # dataset folder (change as needed)
    csv_output_path = '../data/output-mask'                                      # csv output folder (change as needed)
